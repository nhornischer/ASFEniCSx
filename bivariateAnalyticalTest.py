...
if __name__ == '__main__':
    ...
    plt.xlabel(r'$x_1$')
    plt.ylabel(r'$x_2$')
    plt.savefig("figures/2D_function.svg")

    # Define clustered samples
    samples = Clustering(100, 2, 5)
    samples.detect()
    samples.plot("2D_samples.svg")
    ...
    plt.xlabel(r'$x_1$')
    plt.ylabel(r'$x_2$')
    plt.savefig("figures/2D_interpolation.svg")
    ...
    print("Least Squares Interpolation")
    ...
    plt.xlabel(r'$x_1$')
    plt.ylabel(r'$x_2$')
    plt.savefig("figures/2D_least_squares_interpolation.svg")

    cost.reset_number_of_calls()

    # Local interpolation
    cost.interpolation(samples, interpolation_method="local", overwrite=True, clustering = True)
    ...
    plt.xlabel(r'$x_1$')
    plt.ylabel(r'$x_2$')
    plt.savefig("figures/2D_local_interpolation.svg")
    ...
    print("Local Least Squares Interpolation")
    ...
    plt.xlabel(r'$x_1$')
    plt.ylabel(r'$x_2$')
    plt.savefig("figures/2D_local_LS.svg")
